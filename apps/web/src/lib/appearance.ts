...
export const appearanceTemplateOptions: Record<TemplateVariant, Partial<Record<AppearanceTemplate, TemplateOption>>> = {
  light: {
    ...
    paper: template("Paper", "paper", "#171411", "#F7F4EE", "#161412", 45),
  ...
  dark: {
    ...
    graphite: template("Graphite", "graphite", "#F0EADF", "#151412", "#E9E4DA", 60),
    ...
    midnight: template("Midnight", "midnight", "#FAFAFA", "#0A0A0A", "#FAFAFA", 60),
