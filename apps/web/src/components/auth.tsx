        ...
        <div className="h-screen w-screen flex flex-col items-center justify-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                >
                    ...
                    >
                        ...
                        <span>
                            ...
                            <ArrowRightIcon className="ml-2 transition-all duration-500 hidden mb-0.5" width={"14"} height={"14"} />
                        </span>
                    </Button>
                </a>
                <a
                ...
                >
                    ...
                    >
                        Star MindTab on{" "}
                        <svg className="ml-2" width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex items-center">
                <Button size={"lg"} onClick={handleGoogleSignIn} disabled={isSigningIn}>
                    <svg className="mr-2" width="22px" height="22px" viewBox="-3 0 262 262" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
