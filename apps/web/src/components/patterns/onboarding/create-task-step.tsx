...
import { TASK_PRIORITY, TASK_IMPACT, type TaskPriority, type TaskImpact } from "@mindtab/shared";
...
const impactNumber: Record<TaskImpact, number> = {
    low: 1,
    medium: 2,
    high: 3,
};
...
type CreateTaskStepProps = {
    ...
    onTaskCreated: (data: CreatedTaskData) => void;
    onBack: () => void;
    initialData: CreatedTaskData | null;
};
...
export function CreateTaskStep({
    ...
    const [priority, setPriority] = useState<TaskPriority>(initialData?.priority ?? "priority_1");
    const [impact, setImpact] = useState<TaskImpact>(initialData?.impact ?? "medium");
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (alreadyCreated) {
            onTaskCreated({ title: title.trim(), priority, impact });
            return;
        }
        (createTask.mutate as any)(
            {
                title,
    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="space-y-3">
                ...
                >
                    Tasks can move from To Do to Done. What do you want to accomplish?
                </motion.p>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center justify-end space-x-2">
                        ...
                        >
                            {alreadyCreated ? "Continue" : "Add task"}
                        </Button>
                    </div>
                </form>
            </motion.div>
