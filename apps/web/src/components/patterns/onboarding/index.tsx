...
export function Onboarding({ userName, onComplete }: OnboardingProps) {
    ...
    return (
        <div className="flex min-h-screen w-full flex-col items-center bg-gradient-to-b from-background via-background to-background relative overflow-hidden pb-12">
