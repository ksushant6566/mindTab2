...
type CreateGoalDialogProps = CreateGoalProps & { open: boolean; onOpenChange: (open: boolean) => void; };
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogHeader>
                ...
                <DialogDescription className="sr-only">Create a new goal, add a title, description, and other details.</DialogDescription>
            </DialogHeader>
