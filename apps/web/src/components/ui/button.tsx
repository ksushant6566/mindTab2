...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-[var(--r-2)] text-[length:var(--type-label-size)] font-[var(--type-label-weight)] leading-[var(--type-label-line)] ring-offset-background transition-all duration-150 [transition-timing-function:var(--ease-out)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        sm: 'h-8 px-3 text-[length:var(--type-meta-size)] leading-[var(--type-meta-line)]',
        lg: 'h-11 rounded-[var(--r-3)] px-6 text-[length:var(--type-body-size)] leading-[var(--type-body-line)]',
        icon: 'h-9 w-9',
      },
    },
    defaultVariants: {
