...
export function DeleteTaskConfirmDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-[460px] overflow-hidden border border-border bg-[var(--bg-elev)] p-0 shadow-[0_20px_64px_-48px_rgba(0,0,0,0.95)]">
                <DialogHeader className="border-b border-border px-5 py-4 text-left">
                    <DialogTitle className="pr-8 text-lg font-semibold leading-6 tracking-normal text-foreground">
                        Delete task?
                    </DialogTitle>
                    <DialogDescription className="flex items-center gap-1.5 font-mono text-[10.5px] uppercase tracking-[0.06em] text-[var(--rose)]">
                ...
                <div className="bg-[var(--bg)]/45 px-5 pb-5 pt-4">
                    ...
                    <div className="mt-4 flex justify-end gap-2">
                        ...
                        <Button
                            ...
                            variant="outline"
                            size="sm"
                            className="h-8 border-[var(--rose)] bg-transparent text-[var(--rose)] hover:bg-[var(--rose)]/10 hover:text-[var(--rose)]"
                            onClick={onConfirm}
                            loading={isDeleting}
                        >
                            Delete
