...
import { useCreateTask } from "@mindtab/core";
...
export function CreateTaskStep({ projectId, onTaskCreated, onBack }: CreateTaskStepProps) {
  ...
  const handleSubmit = () => {
    ...
    (createTask.mutate as any)(
      ...
      {
        onSuccess: () => onTaskCreated(title.trim()),
